...
HUE_RANGE   	= 361
ITER_LIMIT  	= SAT_RANGE * HUE_RANGE * 2  		# the max no. of iterations that can have a unique colour value
MANDEL_COLOUR	= (  0,  0,  0)		# black
print(f"The number of possible colours in this set will be {(ITER_LIMIT/2)//PIXELS_TO_MOVE}.")
...
while 1:
	...
	mandel_img.save(f"mandelpilv3_{POWER}_{ESCAPE_LIMIT}_{INITIAL_Z}_{PIXELS_TO_MOVE}_{SAT_RANGE}_{iters},{topleft}_{graph_width}_{graph_height}.png")
