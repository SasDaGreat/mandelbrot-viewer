...
def disn(abs_z,abs_dz, escaped):
	if abs_z==0: return (0, 0, RGB_MINUS_1)
...
POWER		= -2
P_MINUS_1 	= POWER-1
ESCAPE_LIMIT= 1e12 				# default: 1e12
...
while 1:
	...
	mandel_img.save(f"mandelpilv5.1_{MOD_BY}_{POWER}_{ESCAPE_LIMIT}_{INITIAL_Z}_{COLOURS}_{iters},{topleft}_{graph_width}_{graph_height}.png")
