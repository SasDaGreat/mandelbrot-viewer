...
while 1:
	...
	pygame.image.save(screen,f"burningshipzoomv1.1_{POWER}_{MAX_ITERS}_{no_of_iterations}_{topleft_coords.real}x{topleft_coords.imag}y_{length_scale_ratio}_{actual_height}.png")
