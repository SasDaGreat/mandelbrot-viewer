...
but I don't know how I can make this readable and understandable.
...
while 1:
		...
		for pygame_y in range(HEIGHT+1):
			...
			for current_iteration in range(no_of_iterations):
				...
				if abs(z) > 2:
					...
					current_colour.r, current_colour.b, current_colour.g = 255, 255, 255
	...
	pygame.image.save(screen,f"mandelbrotzoom_v2versus2.1_inverted_{POWER}_{MAX_ITERS}_{no_of_iterations}_{topleft_coords.real}x{topleft_coords.imag}y_{length_scale_ratio}_{actual_height}.png")
