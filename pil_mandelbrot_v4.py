...
while 1:
	...
	mandel_img.save(f"mandelpilv4_{int(INV_HUE_OFF)}_{POWER}_{ESCAPE_LIMIT}_{INITIAL_Z}_{COLOURS}_{iters},{topleft}_{graph_width}_{graph_height}.png")
