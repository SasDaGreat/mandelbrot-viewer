...
def get_colour(x,y):
	...
	for i in range(iters):
		dzBYdc = POWER * (z**P_MINUS_1) * dzBYdc
		z = z**POWER + c
...
while 1:
	...
	mandel_img.save(f"juliapilv4_@{c}_{MOD_BY}_{POWER}_{ESCAPE_LIMIT}_{COLOURS}_{iters},{topleft}_{graph_width}_{graph_height}.png")
